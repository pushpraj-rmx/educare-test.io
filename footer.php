    ...
    <div class="container">
      <div class="footer-top-section-wrapper">
        <div class="footer-top-section-left">
          <p class="footer-top-section-focus">WE ARE WITH YOUR CHILD AT EVERY STEP</p>
          <p class="footer-top-section-text">Get your child the much-needed individual attention they deserve!</p>
        </div>
        <div class="footer-top-section-right">
          <button  class="btn btn-blue btn-bold"><a href="contact_us.html"><span>GET STARTED NOW</span></a></button>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6 col-xs-6 footer-section-single">
            <div class="footer-educare-widget widget">
              <div class="footer-title-widget">One2One Tutorials</div>
              <div class="footer-content-widget">
                <p>One2One Tutorials is a top online tutoring platform that enables learners of all ages to pick up English, Math, and Science skills while on the go. Your children may achieve in their various fields thanks to One2One Tutorials' highly motivated teachers, who have helped hundreds of students throughout the world. </p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 col-xs-6 footer-section-single">
            <div class="useful-link-widget widget">
              <div class="footer-title-widget">USEFUL LINKS</div>
              <div class="footer-content-widget">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-sm-6 col-xs-6">
                      <ul class="list-unstyled">
                        ...
                        <li><i class="fa fa-angle-right"></i><a href="#">Why choose us?</a></li>
                        
                      </ul>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-6">
                      <ul class="list-unstyled">
                        <li><i class="fa fa-angle-right"></i><a href="#">Our Tutors</a></li>
          ...
          <div class="col-lg-3 col-sm-6 col-xs-6 footer-section-single">
            <div class="footer-educare-widget widget">
              <div class="footer-title-widget">CONTACT INFO</div>
              <div class="footer-content-widget">
                <div class="info-list">
                  <ul class="list-unstyled">
